...
*Marginalia* is the text that was written in the borders of the pages to highlight or summarize the paragraph content. It was printed in the corpus volumes prior to 1951. The marginalia are not part of the *Acts* and not needed for the OCR process, as did paratextual information from page headers and footers. So, we removed that information before OCring the corpus. The marginalia removal process involved two steps:
- Determine the coordinates of the main text body 
