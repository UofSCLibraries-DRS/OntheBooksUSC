...
- As a preprocessing step, all the sentences with less than 27 characters were discarded from model creation. (The number 27 is found after multiple attempts were carried out to check that NO sentence with label 1 is discarded).
